...
class Dataset(models.Model):
    ...
    source_path = models.URLField(max_length=300, blank=True)
    ...
    source_local = models.CharField(max_length=200)
    source_file_size = models.IntegerField(default=0)
    source_local = models.CharField(max_length=200, blank=True)
    source_local_flag = models.BooleanField(default=False)
